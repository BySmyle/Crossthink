                ...
                <form class="contact-form" action="./page_inscription.php" method="POST"> <!-- Dans ce formulaire, on demande à l'utilisateur ses informations personnelles--->
                    ...
                    <div class="center-form">
                        ...
                        <select id="profession" name="profession" required>
                            ...
                            <!-- affiche les professions ajoutée par l'utilisateur à la suites des profession déjà existante -->
                            <?php
                                $query = $lien->prepare("SELECT libelProfession FROM profession");
                                $query->execute();
                                
                                while($row = $query->fetch()) {
                                    echo "<option value='{$row["libelProfession"]}' style='text-align: center;'> {$row["libelProfession"]} </option>";
                                }
                            ?>
                        </select>
                    </div>
